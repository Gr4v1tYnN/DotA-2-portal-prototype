...
<head>
	...
	<meta charset="utf-8">
	<title>Create New Article | DDoser</title>
...
<div class="container content" style="background-color: #e6e6e6;">
	<div class="card">
		<div class="card-head" style="font-size:30px; margin: 0px 0px 15px 0px">Create new article</div>
	</div>

	<form action="http://localhost/diplominis/adm/insertarticle" method="post">
		<input type="hidden" name="articleId" value="<?php echo $articles[0]['article_id']; ?>">
		<div class="form-group">
			<label for="title">Article Title</label><br>
			<textarea name="title" placeholder="Article title" rows="1" cols="140" required></textarea>
		</div>
		<div class="form-group">
			<label for="header">Article Header</label><br>
			<textarea name="header" placeholder="Article header" rows="4" cols="140"></textarea>
		</div>
		<div class="form-group">
			<label for="abody">Article Text</label><br>
			<textarea name="abody" placeholder="Article text" rows="40" cols="140" required></textarea>
		</div>
	  <input type="submit" class="floated btn btn-success" value="Submit">
	</form>
	<form action="http://localhost/diplominis/home/index">
