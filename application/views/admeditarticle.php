...
<head>
	...
	<meta charset="utf-8">
	<title>Edit Article #<?php echo $article[0]['article_id']; ?>  | DDoser</title>
...
<?php if ($this->session->userdata('status') == 1): ?>
	...
	<div class="container content" style="background-color: #e6e6e6;">
		...
		<form action="http://localhost/diplominis/adm/editarticle" method="post">
			<input type="hidden" name="articleId" value="<?php echo $article[0]['article_id']; ?>">
			<div class="form-group">
				<label for="title">Article Title</label><br>
				<textarea name="title" rows="1" cols="140" required><?php echo $article[0]['title'];?></textarea>
			</div>
			<div class="form-group">
				<label for="header">Article Header</label><br>
				<textarea name="header" rows="4" cols="140"><?php echo $article[0]['header'];?></textarea>
			</div>
			<div class="form-group">
				<label for="abody">Article Text</label><br>
				<textarea name="abody" rows="40" cols="140" required><?php echo $article[0]['body'];?></textarea>
			</div>
			
		  <input type="submit" class="floated btn btn-success" value="Submit">
		</form>
		<form action="http://localhost/diplominis/adm/cancelartedit" method="post">
			<input type="hidden" name="cancelId" value="<?php echo $article[0]['article_id']; ?>">
