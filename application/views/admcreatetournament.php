...
<head>
	...
	<meta charset="utf-8">
	<title>Create New Tournament | DDoser</title>
...
<div class="container content" style="background-color: #e6e6e6;">
	<div class="card">
		<div class="card-head" style="font-size:30px; margin: 0px 0px 15px 0px">Create new tournament</div>
	</div>

	<form action="http://localhost/diplominis/adm/inserttournament" method="post">
		...
		<div class="form-group">
			...
			<input type="number" name="prizepool" placeholder="Prizepool">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="number" name="participantsNumber" placeholder="Number of participants">
		</div>
		<div class="form-group">
			<label for="participants">Participants</label><br>
			<input type="text" name="participants" placeholder="Participating teams">
		</div>
	  <input type="submit" class="floated btn btn-success" value="Submit">
	</form>
	<form action="http://localhost/diplominis/tournaments/index">
